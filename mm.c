...
/* Given free block ptr bp, compute address of address of prev_block or succ_block */
...
static void insert_list(void *p);
static void remove_list(void *p);
